package pdbp.computation.transformation.writing.log.sl4j
...
import pdbp.computation.transformation.writing.log.logWritingTransformation._

import pdbp.computation.transformation.writing.log.LogWritingTransformation

private[pdbp] trait LogWritingUsingSl4jTransformation[M[+ _]: Computation]
    extends LogWritingTransformation[M]
